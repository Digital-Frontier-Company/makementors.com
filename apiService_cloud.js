// Cloud API Service Configuration for Production Deployment
// This version points to the deployed cloud backend

// Cloud backend URL (our deployed Flask API)
const CLOUD_API_URL = 'https://19hnincl9mo3.manus.space/api';
...
const getApiBaseUrl = () => {
  ...
  // For production deployment, use the cloud backend
