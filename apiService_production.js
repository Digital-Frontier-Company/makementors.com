// Production API Service Configuration for Hostinger Deployment
// This version points to the cloud backend for AI functionality

// Cloud backend URL (our deployed Flask API)
const CLOUD_API_URL = 'https://0vhlizcpy68o.manus.space/api';

// Determine the correct API base URL based on environment
const getApiBaseUrl = () => {
  // If we're in development (localhost), use localhost for testing
  if (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') {
    return 'http://localhost:5000/api';
  }
  // For production deployment on Hostinger, use the cloud backend
